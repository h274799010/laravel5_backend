...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.content.classify', compact('list'));
    }
    ...
    public function add()
    {
        ...
        $list=(new CategoryModel())->allCategory();
        $select= Tree::dropDownSelect(Tree::genTree($list));
        return view('admin.content.classifyadd', compact('formUrl','select'));
    }
    ...
    public function edit()
    {
        ...
        return view('admin.content.classifyadd', compact('info', 'formUrl', 'id','select'));
    }
