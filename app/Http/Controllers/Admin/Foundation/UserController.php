...
class UserController extends Controller
{
    ...
    public function add()
    {
        ...
        return view('admin.user.add',
            compact('groupList', 'formUrl','select')
        );
    }
    ...
    public function edit()
    {
        ...
        $list=(new DeptModel())->allDept();
        $select= Tree::dropDownSelect(Tree::genTree($list),$userInfo['dept_id']);
        return view('admin.user.add', compact('userInfo', 'formUrl', 'id', 'groupList','select'));
    }
